...
class Ion_auth_model extends CI_Model
{
	 ...
	 * @author    Mathew
	 */
	public function register($identity, $password, $email, $username, $additional_data = [], $groups = [])
	{
		...
		$ip_query = $this->db->get_where('users', array('ip_address' => $ip_address));
		if($ip_query->num_rows() > 0)
		{
			$this->set_error('double_ip');
			return FALSE;
		}

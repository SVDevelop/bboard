 ...
 */
$config['site_title']                 = "bboard.club";       // Site Title, example.com
$config['admin_email']                = "admin@bboard.club"; // Admin Email, admin@example.com
...
$config['user_expire']                = 2592000;               // 86500 ->def How long to remember the user (seconds). Set to zero for no expiration - see sess_expiration in CodeIgniter Session Config for session expiration
...
$config['maximum_login_attempts']     = 4;                   // The maximum number of failed login attempts.
...
/*
 ...
 | Default: auth/
 */
$config['email_templates'] = 'bboard/email/';
